...
@section('breadcrumbs')
    <li class="breadcrumb-item active">Utilisateurs admin</li>
@stop
@section('content')
        ...
        <div class="card">
            <div class="card-header ">
                <div class="d-flex justify-content-between">
                    <h2 class="mb-0">Utilisateurs admin</h2>
                    <a href="{{ route('admin.admin-users.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter un admin</a>
                </div>
            </div>
            <div class="card-body">
